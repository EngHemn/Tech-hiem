      ...
      <AnimatePresence>
        {mobileNavOpen && (
          <motion.div
            ...
            className="fixed top-0 left-0 w-[280px] h-full bg-background border-r z-40 p-4 shadow-xl md:hidden"
          >
              ...
              <div className="flex-1 space-y-1 overflow-y-auto">
                {menuItems.map((item) => (
                  <Link
                    ...
                    onClick={toggleMobileNav}
                    className={`flex items-center gap-3 px-3 py-3 rounded-md transition-all duration-300 ease-in-out ${
                      getIsActive(item.url)
                        ? "bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 font-medium"
                        : "hover:bg-blue-50 dark:hover:bg-blue-900/20 text-foreground"
                    }`}
                  >
                    <item.icon size={18} />
                    <span>{item.name}</span>
                  ...
                  <Link
                    ...
                    className={`flex items-center ${
                      sidebarExpanded
                        ? "justify-start px-3"
                        : "justify-center px-0"
                    } py-3.5 mb-1 rounded-md transition-all duration-300 ease-in-out ${
                      getIsActive(item.url)
                        ? "bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 font-medium"
                        : "hover:bg-blue-50 dark:hover:bg-blue-900/20 text-foreground"
                    }`}
