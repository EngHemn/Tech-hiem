...
const StatCard = ({ title, count, icon, color, onRouter }) => {
  return (
    <motion.div
      onClick={onRouter}
      className={`p-4 md:hover:scale-105 active:scale-75 transition-all duration-300  rounded-2xl shadow-2xl ${color} text-white flex items-center space-x-6 relative overflow-hidden border border-gray-600`}
    >
      <motion.div
